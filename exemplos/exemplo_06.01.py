...
import os         # Importa a biblioteca 'os', usada para interagir com o sistema operacional (variáveis de ambiente, caminhos de arquivo, etc.)
...
openai_api_key = os.getenv("OPENAI_API_KEY")  # Obtém a chave da API da OpenAI a partir de uma variável de ambiente
